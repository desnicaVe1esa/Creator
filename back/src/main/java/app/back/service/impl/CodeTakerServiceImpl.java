...
@Service
public class CodeTakerServiceImpl implements CodeTakerService {

    public CodeTakerServiceImpl() {
...
////            FileUtils.copyFile(scrFile, new File("C:\\Users\\seera\\IdeaProjects\\back\\screen\\" + language + ".png"));
...
//                    new File("C:\\Users\\seera\\IdeaProjects\\back\\screen\\" + language + ".png"));
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
----------------------------------------------------------------------------------------------------------------------*/
...
/*------------------------------------------------- Deprecated ---------------------------------------------------------
        return ScreenshotService.takeTextFromPicture("C:\\Users\\seera\\IdeaProjects\\back\\screen\\" + language + ".png");
----------------------------------------------------------------------------------------------------------------------*/
